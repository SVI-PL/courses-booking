<?php
if ( ! class_exists( 'Experts_Template_Loader' ) ) {


	class Experts_Template_Loader {
		/**
		 ...
		 * @var string
		 */
		protected $filter_prefix = 'booking';
		 ...
		 * @var string
		 */
		protected $theme_template_directory = 'booking';
		 ...
		 * @var string
		 */
		protected $plugin_directory = Almosoft_Course_booking_file;
